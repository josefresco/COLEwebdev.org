...
window.INDUSTRY_DATA = [
  ...
  },
  {
    ...
    intro: "Health and wellness businesses live and die by trust. Before a potential patient or member calls your office or walks through your door, they have almost certainly looked you up online and formed an opinion based on what they found. A professional, welcoming website that communicates your approach, your credentials, and what makes your practice distinctive is the first step in a relationship that may last years. We have built websites for Cape Cod health and wellness businesses across the spectrum, from medical practices to fitness studios to therapists.",
    whyCards: [
      ...
      { icon: '◎', title: 'Your online presence sets the expectation', body: "A polished, professional site signals the same thing your office interior does: you take quality seriously. A site that looks dated or is hard to navigate on mobile signals the opposite, often before a patient reads a word." },
  ...
  },
  {
    ...
    intro: "Professional services firms have one primary job for their website: establish credibility fast enough that a prospective client contacts you rather than your competitor. That means clear practice area descriptions, compelling attorney or advisor profiles, and a design that signals competence before anyone reads a word. We have built websites for Cape Cod law firms, financial advisors, consultants, and bookkeepers, and we understand what a professional services site needs to do to generate meaningful inquiries.",
    whyCards: [
      { icon: '◇', title: 'Credibility decides who gets the call', body: "Prospective clients comparing attorneys or consultants online make their initial decision based on website quality before they read a bio or call an office. A professional, well-organized site is the baseline for being taken seriously." },
    ...
    features: [
      ...
      { icon: '◎', title: 'Testimonials & Social Proof', body: "Client testimonials and case outcomes (where ethically permissible) presented professionally. Trust signals that validate the prospective client's decision to reach out." },
  ...
  },
  {
    ...
    intro: "Cape Cod charter and marine businesses book months in advance, and most of those bookings happen online before a customer ever picks up the phone. A well-built charter website that loads fast on mobile, shows your boat and experience clearly, and makes booking as simple as possible is the most direct investment you can make in next season's revenue. We have built websites for Cape Cod fishing charters, whale watching operations, and marine service businesses, and we understand the seasonal, visual nature of this work.",
    whyCards: [
      ...
      { icon: '✦', title: 'Mobile is where the booking decision happens', body: "Visitors already on the Cape make last-minute charter decisions on their phones. A site that is not fast and easy on mobile loses those bookings to a competitor who is." },
    ],
    features: [
      ...
      { icon: '◇', title: 'Trip & Package Pages', body: "Individual pages for each trip type — full-day, half-day, family trips, corporate — with rates, what's included, meeting location, and a book now button." },
