...
window.LOCATIONS_DATA = [
  ...
  },
  {
    ...
    nearbyTowns: [
      ...
      { name: 'Truro', href: 'truro-web-design.html' },
      { name: 'Eastham', href: 'eastham-web-design.html' },
      { name: 'Nantucket', href: 'nantucket-web-design.html' },
    ],
  ...
  },
  {
    ...
    nearbyTowns: [
      ...
      { name: "Martha's Vineyard", href: 'marthas-vineyard-web-design.html' },
    ],
  ...
  },
  {
    ...
    nearbyTowns: [
      ...
      { name: 'Mashpee', href: 'mashpee-web-design.html' },
      { name: 'Plymouth', href: 'plymouth-web-design.html' },
    ],
  ...
  },
  {
    ...
    city: 'Nantucket',
    state: 'MA',
    slug: 'nantucket-web-design',
    heroHeadline: 'Nantucket Web Design',
    heroSub: "Where every first impression is formed online. We build websites for Nantucket's most demanding markets.",
    intro: "Nantucket operates at a different standard than most markets — premium accommodations, celebrated restaurants, sophisticated retail, and a clientele that expects excellence at every touchpoint. Long before a visitor boards the ferry, they have researched your business online, compared you to competitors, and formed a strong opinion. A website that matches the quality of your business is the baseline for competing here. We build websites for Nantucket businesses that meet that expectation.",
    localContext: "Nantucket's summer season is compressed and intensely competitive — every visitor arrives by choice and with high expectations. The businesses that win the season are the ones whose online presence communicates quality before the customer ever steps foot on the island. A slow, outdated, or poorly designed website is a liability here in a way it simply isn't in lower-stakes markets. We build websites that match the character of the island.",
    industries: ['Hospitality & Inns', 'Restaurants', 'Boutique Retail', 'Real Estate', 'Marine', 'Arts & Culture'],
    clients: [],
    faq: [
      {
        q: 'Do you build websites for Nantucket businesses?',
        a: "Yes — we serve clients on Nantucket and understand what the island's market demands. Nantucket visitors are sophisticated and discerning, and they form strong opinions about your business based on your online presence before they arrive. We build websites that match the standard of the island.",
      },
      {
        q: 'Our Nantucket business is seasonal. How do we use the off-season wisely?',
        a: "The off-season is when next summer's bookings are made. Visitors planning a Nantucket trip in January and February are already searching and comparing options. A well-optimized website that ranks for Nantucket searches captures those early-stage planners before your competitors do. We help you position your site to win the planning season, not just peak season.",
      },
      {
        q: 'How do we compete with travel platforms for Nantucket visitor searches?',
        a: "Platforms like TripAdvisor and Booking.com rank well for generic destination searches, but your own site wins for branded searches, direct bookings, and customers specifically looking for your business. A direct booking also means no platform commission. We build sites that drive direct business while complementing your presence on the platforms.",
      },
    ],
    nearbyTowns: [
      { name: 'Provincetown', href: 'provincetown-web-design.html' },
    ...
    metaTitle: 'Nantucket Web Design — COLEwebdev · Massachusetts',
    metaDesc: "Web design for Nantucket, MA businesses. COLEwebdev builds high-converting websites for the island's hospitality, retail, restaurant, and service businesses.",
    schemaLocality: 'Nantucket',
  },
  {
    id: 'marthas-vineyard',
    city: "Martha's Vineyard",
    state: 'MA',
    slug: 'marthas-vineyard-web-design',
    heroHeadline: "Martha's Vineyard Web Design",
    heroSub: 'Six towns, two million visitors, one studio ready to serve the island.',
    intro: "Martha's Vineyard is one of the most sought-after destinations in New England — six distinct towns from the gingerbread Victorian charm of Oak Bluffs to the working harbor of Menemsha, each with its own character and clientele. We build websites for Martha's Vineyard businesses that capture the island's diversity: from high-end Edgartown hospitality to working waterfront fish markets, from boutique retail on Circuit Avenue to year-round contractors who keep the island running.",
    localContext: "Vineyard businesses operate in a highly competitive, highly seasonal market where the summer window is short and the stakes are high. Visitors research everything before they arrive — where to stay, where to eat, what to do — and the businesses with the clearest, fastest, most compelling online presence win those decisions. An MV website also needs to serve a year-round community of residents who rely on local services across every season. We build websites that work for both.",
    industries: ['Hospitality & Inns', 'Restaurants', 'Marine & Fishing', 'Boutique Retail', 'Arts & Culture', 'Contractors'],
    clients: [],
    faq: [
      {
        q: "Do you build websites for Martha's Vineyard businesses?",
        a: "Yes — we serve Martha's Vineyard clients and understand the island's unique market dynamics. Six towns with distinct characters, a compressed summer season, and a discerning visitor base that researches before they arrive — we build websites that perform in exactly this environment.",
      },
      {
        q: 'The Vineyard is so competitive in summer. How does a website actually help?',
        a: "Online presence is where the summer competition is decided — months before the first summer visitor arrives. The inn that ranks for 'Martha's Vineyard inns' in March fills its July calendar. The restaurant with a clear, mobile-first site and a working reservation link wins the dinner booking while competitors without one don't. We build for this market.",
      },
      {
        q: 'We run a year-round service business on MV. What does our site need?',
        a: "Year-round Vineyard service businesses — contractors, healthcare, professional services — need sites that rank for local searches by residents, not just visitor traffic. That means strong local SEO for town-specific searches, clear service descriptions, and an easy contact path. We build sites that generate steady local leads year-round, not just summer spikes.",
      },
    ],
    nearbyTowns: [
      { name: 'Nantucket', href: 'nantucket-web-design.html' },
    ...
    metaTitle: "Martha's Vineyard Web Design — COLEwebdev · Massachusetts",
    metaDesc: "Web design for Martha's Vineyard businesses. COLEwebdev builds websites for MV's hospitality, restaurants, retail, and year-round service businesses.",
    schemaLocality: "Martha's Vineyard",
  },
  {
    id: 'plymouth',
    city: 'Plymouth',
    state: 'MA',
    slug: 'plymouth-web-design',
    heroHeadline: 'Plymouth Web Design',
    heroSub: "America's Hometown. Strong year-round market. We build websites that deliver leads in every season.",
    intro: "Plymouth sits at the intersection of history and opportunity — home to Plimoth Patuxent, the Mayflower II, and some of the most visited historic sites in New England, while also serving a large and growing year-round residential base. We build websites for Plymouth businesses that serve both audiences: the visitor who comes for the history and the resident who needs services all year.",
    localContext: "Plymouth's economy is year-round in a way that distinguishes it from strictly seasonal Cape Cod markets. The history tourism brings visitors through the shoulder seasons, and the large residential base supports a full range of local services. That means Plymouth business websites need to work in two modes: capturing tourist traffic in peak season and generating steady local leads through the rest of the year. We build for both.",
    industries: ['Tourism & Heritage', 'Restaurants', 'Healthcare', 'Contractors', 'Retail', 'Professional Services'],
    clients: [],
    faq: [
      {
        q: 'Do you build websites for Plymouth businesses?',
        a: "Yes — Plymouth is part of our greater southeastern Massachusetts service area, and the market here is genuinely strong. A large year-round residential base combined with significant tourism traffic makes Plymouth one of the most opportunity-rich markets in the region for a well-positioned web presence.",
      },
      {
        q: 'Plymouth has a big tourist draw. How do we make the most of that on our website?',
        a: "Tourism-driven traffic is captured through local SEO for visitor-facing searches — 'restaurants near Plymouth Rock,' 'things to do in Plymouth MA,' 'Plymouth MA shopping.' We build landing pages that target those searches, optimize your Google Maps listing, and give visitors an immediate reason to choose your business over a generic directory listing.",
      },
      {
        q: "We're a local service business in Plymouth — does a website really generate leads here?",
        a: "Yes — Plymouth's residential population is large and growing, and local service searches are all driven heavily by Google. A professional website with local SEO consistently generates new customer inquiries for service businesses in the Plymouth market. We have seen it work for comparable communities throughout southeastern Massachusetts.",
      },
    ],
    nearbyTowns: [
      { name: 'Cape Cod', href: 'cape-cod-web-design.html' },
    ...
    metaTitle: 'Plymouth Web Design — COLEwebdev · Massachusetts',
    metaDesc: "Web design for Plymouth, MA businesses. COLEwebdev builds websites for tourism, restaurants, contractors, healthcare, and local services in America's Hometown.",
    schemaLocality: 'Plymouth',
  },
];
