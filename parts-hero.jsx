...
const SEARCH_DATA = [
  ...
  { title: 'Nantucket Web Design', desc: "Web design for Nantucket's hospitality, retail, and service businesses.", category: 'Location', href: 'nantucket-web-design.html' },
  { title: "Martha's Vineyard Web Design", desc: "Websites for MV's hospitality, restaurants, retail, and year-round service businesses.", category: 'Location', href: 'marthas-vineyard-web-design.html' },
  { title: 'Plymouth Web Design', desc: "Web design for Plymouth, MA — tourism, restaurants, contractors, and local services.", category: 'Location', href: 'plymouth-web-design.html' },
